package com.gizmo.gsdksmaple.camera;
...
public class CameraUtils {
     ...
     * @param expectFps
     */
    public static void openBackCamera(int expectFps, Camera.PreviewCallback previewCallback) {
        if (mCamera != null) {
     ...
     * @param expectFps
     */
    public static void openCamera(int cameraID, int expectFps,Camera.PreviewCallback previewCallback) {
        if (mCamera != null) {
            throw new RuntimeException("camera already initialized!");
        }
     ...
     * @param cameraID
     */
    public static void switchCamera(int cameraID, SurfaceHolder holder,Camera.PreviewCallback previewCallback) {
        ...
        releaseCamera();
        // 打开相机
        openCamera(cameraID, CameraUtils.DESIRED_PREVIEW_FPS,previewCallback);
        // 打开预览
