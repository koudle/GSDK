...
import com.gizmohub.sdk.cacheWebView.jsbridge.BridgeUtil;
...
final class CacheWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView webView, String url) {
        ...
        if (cacheWebView.getStartupMessage() != null) {
            for (com.gizmohub.sdk.cacheWebView.jsbridge.Message m : cacheWebView.getStartupMessage()) {
...
//    }
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        ...
        WebResourceResponse resourceResponse = mWebViewCache.getWebResourceResponse(this,url,mCacheStrategy,
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        WebResourceResponse resourceResponse = mWebViewCache.getWebResourceResponse(this,request.getUrl().toString(),
